...
import option2.domain.model.Thing1
import option2.domain.deps.Thing1Store
import option2.domain.model.{DomainError, Thing1}
import option2.infra.thing1.{Thing1Row, Thing1Table}
...
object Thing1StoreImpl {
  val layer: ULayer[Thing1Store.WithTxn[Connection]] = ZLayer.succeed(new Thing1StoreImpl)
}
